...
const output = this.saxonArmy[randomSaxon].receiveDamage(this.vikingArmy[randomViking].attack());
...
const randomSaxon = Math.floor(Math.random()*this.saxonArmy.length);
const randomViking = Math.floor(Math.random()*this.vikingArmy.length);
const output = this.vikingArmy[randomViking].receiveDamage(this.saxonArmy[randomSaxon].attack());
